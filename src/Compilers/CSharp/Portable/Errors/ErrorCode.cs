...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal enum ErrorCode
    {
        ...
        ERR_ValueTypeUsedInNonNullableType = 9000,
        ERR_NullAssignedToNonNullableType = 9001,
        ERR_DefaultOperatorUsedWithPreservedTypeParameter = 9002,
        ERR_NonNullableReferenceUsedInAsOrIsExpression = 9003,
    }
}